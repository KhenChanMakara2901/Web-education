  ...
  return (
    <section className="bg-sky-900 py-20">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
        <div className="max-w-2xl lg:max-w-4xl mx-auto text-center animate-slideIn">
          <h2 className="text-5xl font-extrabold underline text-white">
            ទីតាំងរបស់យើង៖
          </h2>
          <p className="mt-4 underline text-xl text-white">ខ្មែរកូដ អាខាដឺមី</p>
        </div>
        <div className="mt-16 lg:mt-20 animate-slideIn">
            ...
            <div>
              <div className="max-w-full mx-auto rounded-lg overflow-hidden">
                ...
                <div className="border-t border-gray-200 px-6 py-4 animate-fadeIn">
                  ...
                  <p className="mt-5 text-xl text-white">
                    អ៊ីមែល: khmercodeacademy@gmail.com
                  </p>
                  <p className="mt-5 text-xl text-white">
